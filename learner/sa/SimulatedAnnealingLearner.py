...
def test_learner(learner_type, input_type, pp=True, cp=False, coordination=False, input_size=50, user_input=False,
                 temperature=100):
...
def run_learner():
    ...
    # Head initial:
    input = get_custom_text(size=50, with_transitive="initial", with_dp=None, with_prepositions="initial", with_cp=None,
                            recursion_depth=1)
