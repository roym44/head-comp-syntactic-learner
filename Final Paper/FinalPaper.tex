...
% Simulated Annealing (henceforth SA)
% genetic algorithm (henceforth GA)
...
\clearpage
% -------------------------------------------------------
% 2 - Background (Avraham 1 - Head-Complement order)
% -------------------------------------------------------
\section{Background} 
...
\subsection{Head-Complement Order} % all the things Roni said about this in class, ending in Tomer's work - should I bring it now? or in the second half? I think it depends on the amount of time I'll have - but to the final paper it is important (and adds 1 page or 2!)
...
\clearpage
% -------------------------------------------------------
% 3 - Main: Implementing GA and running the experiments
% -------------------------------------------------------
...
% TODO: the work included first adapting the current code from python 2 to python 3.11 which will enable further and more modern development 
