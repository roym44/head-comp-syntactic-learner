...
% current implementation uses SA - has some disadvantages, things that can be improved using more recent tools and methods
However, current results show the learner prefers the "wrong" grammar over the expected grammar.

% (which compremises the first part of my seminar paper),
...
\subsection{Research Question / Proposal} % my proposal and its motivation
